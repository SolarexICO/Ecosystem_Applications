...
<header id="header-container" class="fullwidth">
	...
	<!-- Header -->
	<div id="header" >
		<?php $pageTop=4; include_once 'header.php'; ?>
			...
			<div class="contact-location-info margin-bottom-50">
				<div class="contact-address">
					<ul>
						...
						<li>51 Duke Street, Chelmsford , Essex, CM1 1JA United Kingdom</li>
						<li>+44798532446</li>
						<li><a href="mailto:info@solarex.io">info@solarex.io</a></li>
						<li>
