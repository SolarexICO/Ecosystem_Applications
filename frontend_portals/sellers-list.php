...
$ch = curl_init();
$sellers=' ';
curl_setopt($ch, CURLOPT_URL, "http://18.224.62.217:3000/api/org.solar.ex.Seller");
...
for ($i=0; $i < sizeof($res); $i++) { 
    ...
    /*$sellers.='<a 
  					 href="gig-detail.html?gigId='.$res[$i]["gigId"].'" class="job-listing">
					...
					<div class="job-listing-details">
						...
						<div class="job-listing-description">
							...
							<h3 class="job-listing-title">'.$res[$i]["gigId"].'</h3>
						</div>
					</div>
					...
					<div class="freelancer-overview">
						<div class="freelancer-overview-inner">
							...
							<div class="freelancer-avatar">
								...
								<a href="seller-profile.php?uId='.$res[$i]["email"].'"><img src="'.$res[$i]["image"].'" alt=""></a>
							</div>

							<!-- Name -->
							<div class="freelancer-name">
								<h4><a href="seller-profile.php?uId='.$res[$i]["email"].'">'.$res[$i]["name"].' <img class="flag" src="images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer-details">
						<div class="freelancer-details-list">
							<ul>
								...
								<li>Energy Available <strong>'.$res[$i]["energy"].' kw</strong></li>
							</ul>
						</div>
						<a href="seller-profile.php?uId='.$res[$i]["email"].'" class="button button-sliding-icon ripple-effect">View Profile <i class="icon-material-outline-arrow-right-alt"></i></a>
					</div>
				</div>
				<!-- Freelancer / End -->';
